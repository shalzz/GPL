...
import myClasses.DbPopulatorThread;
...
public class Setup extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel0.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, -1, -1));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        if (rb3.isSelected() || rb4.isSelected()) 
        {
            ...
            if (rb3.isSelected()) 
            {
                ...
                DbPopulatorThread task = new DbPopulatorThread();   
                logger.debug("exectuing worker");
                task.execute(); 
                logger.debug("exectuted worker");
                ...
                logger.debug("GUI Should be updated");
